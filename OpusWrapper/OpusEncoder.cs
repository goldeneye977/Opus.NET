...
namespace FragLabs.Audio.Codecs
{
    ...
    public class OpusEncoder : IDisposable
    {
        ...
        /// <param name="codingMode">Coding mode.</param>
        /// <returns>A new <c>OpusEncoder</c></returns>
        public static OpusEncoder Create(int inputSamplingRate, int inputChannels, CodingMode codingMode)
        {
            ...
            IntPtr encoder = API.opus_encoder_create(inputSamplingRate, inputChannels, (int)codingMode, out var error);
            if ((Error)error != Error.OK)
            {
                throw new Exception("Exception occured while creating encoder");
            }
            return new OpusEncoder(encoder, inputSamplingRate, inputChannels, codingMode);
        }

        private IntPtr _encoder;

        private OpusEncoder(IntPtr encoder, int inputSamplingRate, int inputChannels, CodingMode codingMode)
        {
            _encoder = encoder;
        ...
        /// </summary>
        public CodingMode CodingMode { get; private set; }
